...
#include "SparkFun_vl53l1_register_map.h"
...
{
 public:
   boolean begin(i2c_context i2c_bus = 0); //By default use the default I2C address, and use Wire port
 ...
 private:
   //Variables
   i2c_context _i2cPort; //The generic connection to user's chosen I2C hardware
